/* ============================================================== *
  ...
  SCROLLER SUBROUTINES

  Subroutines for "smooth-scroll-03.asm"
...
init: {        	lda #$06	// set background color
        	sta $d020
...
move_logo: {    lda SCREEN_RAM+40*5	// grab first characters
	        ...
	        ldx #$00
loop:           lda SCREEN_RAM+40*5+1,x		// shift row1
